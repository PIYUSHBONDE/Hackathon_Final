...
import { InvestmentPredictionResultComponent } from './components/investment-prediction-result/investment-prediction-result.component';
...
@NgModule({
  declarations: [
    ...
    InvestmentPredictionResultComponent
  ],
  imports: [
    FormsModule,
    ReactiveFormsModule,
